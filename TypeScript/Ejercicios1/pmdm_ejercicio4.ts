...
function filtrarArrayAnimalesPorTipo(tipo: string) {
    return animal => animal.especie === tipo ;
};

let arrayFiltrado = arrayAnimales.filter(filtrarArrayAnimalesPorTipo("Perro"));
console.log(arrayFiltrado);