...
// Opción 3 -> arrow
console.log("Mostrando antes de los cambios:");
empleados.forEach(function (empleado) { return console.log("Nombre: " + empleado.nombre + " y Nuevo Salario: " + empleado.salario); });
var subirSalario = function (porcentaje) { return function (empleado) { return empleado.salario += empleado.salario * porcentaje / 100; }; };
var nuevosSalarios = empleados.map(subirSalario(10));
