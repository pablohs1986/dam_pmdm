...
// EJERCICIO 1
// Apartado A
let filtro = (arrayAnimales: any[], especie: string): any[] => arrayAnimales.filter((animal: any): any => animal.especie === especie);
...
// Apartado B
let filtroEspecie = (especie: string): any => (animal: any): any => animal.especie === especie;
